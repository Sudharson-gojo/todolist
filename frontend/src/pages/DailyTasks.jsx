...
const DailyTasks = () => {
  ...
  const fetchTasks = async () => {
    try {
      setLoading(true);
      const response = await axios.get('/api/tasks?category=daily', {
  ...
  return (
    <div className="min-h-screen tasks-page">
      ...
      <div className="container py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="tasks-title mb-2">Daily Tasks</h1>
          <p className="tasks-subtitle">Plan smart, finish strong.</p>
        </div>

        {/* Add Task Form */}
        <AddTaskForm onAddTask={addTask} defaultCategory="daily" />
        ...
        {/* Loading State */}
        {loading ? (
          <LoadingSpinner message="Loading your daily tasks..." />
        ) : (
            ...
            <div className="tasks-section pending">
              ...
              {pendingTasks.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">No pending daily tasks</h3>
                  <p className="text-white opacity-80">Add your first daily task above!</p>
                </div>
              ) : (
